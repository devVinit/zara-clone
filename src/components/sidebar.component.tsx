...
export const SideBarComponent: React.SFC<SideBarComponentProps> = (props) => {
  return <div className={`fixed bg-white h-screen flex items-center justify-center overflow-hidden transition-all duration-500 ${props.isHoverSideBar ? 'w-1/4' : 'w-0'}`}
