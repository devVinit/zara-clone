...
export const HeaderComponent: React.FC<HeaderComponentProps> = (props) => {
	return <header className="h-24 pt-6 relative">
		<div className="flex items-center justify-between mx-3">
			<div className="flex items-center">
				<div className="mr-3 pr-2 cursor-pointer">
					<svg width="32" height="32">
						<path fill="#000" fill-rule="evenodd" d="M4 9h25v.5H4V9zm0 7.2h25v.5H4v-.5zm.3 7.3H4v.5h25v-.5H4.3z" clip-rule="evenodd" />
					</svg>
				</div>
			...
			<div className="absolute inset-y-0.right-0 flex items-center justify-center mt-4">
